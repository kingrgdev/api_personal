...
class AuthController extends Controller
{
    public function search_user(Request $request){
        ...
        else
        {
            ...
            // // $actRecords->for_company_id = "NONE";
            // $actRecords->type = "SEARCH";
    ...
    public function show_dtr_list(Request $request)
    {
        ...
        else
        {
            ...
            // $count_dtr_list_query = "SELECT COUNT(*) FROM `date_time_records` WHERE (DATE(datetime) BETWEEN '".$start_date."' AND '".$end_date."')";
            // $count_dtr_list = DB::connection('mysql')->select($count_dtr_list_query);

            

            // return response([
            //     'status'=>'oK',
            //     'Total rows'=>$count_dtr_list,
            //     'data'=>$show_dtr_list
            // ]);
    ...
    public function timekeeping_app(Request $request)
    {
        ...
        $user_info = User::where('company_id',$companyID)->first();
        ...
        else
        {
            ...
            // $actRecords->token_id = $tokenArray;
            // $actRecords->by_user_id = Auth::user()->id;
            // $actRecords->for_company_id = $companyID;
            // if($request->state == "C/In"){
            //     $actRecords->type = "TIME_IN";
            // }else if($request->state == "C/Out"){
            //     $actRecords->type = "TIME_OUT";
            // }else{
    ...
    public function register(Request $request)
    {
        ...
        else
        {
            ...
            {$user->email = $request->email;
                ...
                $actRecords->token_id = $tokenArray;
                $actRecords->by_user_id = Auth::user()->id;
                $actRecords->for_company_id = $request->company_id;
                $actRecords->type = "REGISTER";
                // $actRecords->status = "NONE";
                $actRecords->save();
